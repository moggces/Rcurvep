...
In `combi_run_rcurvep` function, `future_pmap` function from **furrr** package is embedded. 
Using `future_pmap` function again decreases the speed.
...
par_run_bmr2 <- expression(
  ...
  future_pmap(inp_tb, ~ combi_run_rcurvep(..4, TRSH = ..3, RNGE = ..1, n_samples = 100, seed = 300, keep_sets = c("act_set")), .options = furrr_options(seed = 2023)),
